...
; Elite Four and Champion
	...
	const EVENT_OAK_CALLED_ABOUT_BLUE_COLLAR
	const EVENT_GOT_BLUE_COLLAR_FROM_OAKS_AIDE
	const EVENT_GOT_LAZER_COLLAR_FROM_ELM
	const EVENT_ELM_CALLED_ABOUT_LAZER_COLLAR
...
; Johto people
	...
	const EVENT_OAKS_AIDE_IN_GOLDENROD_POKEMON_CENTER
