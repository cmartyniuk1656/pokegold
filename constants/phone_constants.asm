...
; SpecialPhoneCallList indexes (see data/phone/special_calls.asm)
	...
	const SPECIALCALL_OAK_ELITE_FOUR_REMATCH
	const SPECIALCALL_OAK_MT_SILVER
	const SPECIALCALL_OAK_BLUE_COLLAR
	const SPECIALCALL_ELM_LAZER_COLLAR
	const SPECIALCALL_ELM_EVOLUTION_SECRETS
