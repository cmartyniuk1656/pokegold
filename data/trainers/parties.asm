...
KarenGroup:
	...
	db 42, LUMBREON,   SAND_ATTACK, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
...
CooltrainerMGroup:
	...
	db 34, FLITTLE,    SAND_ATTACK, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end
	...
	db 38, FLITTLE,    SAND_ATTACK, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end
	...
	db 32, FLITTLE,    SAND_ATTACK, QUICK_ATTACK, BITE, FIRE_SPIN
	db -1 ; end
...
SabrinaGroup:
	...
	db 46, LITEON,     SAND_ATTACK, QUICK_ATTACK, SWIFT, PSYCHIC_M
...
RedGroup:
	...
	db 73, LITEON,     MUD_SLAP, REFLECT, SWIFT, PSYCHIC_M
